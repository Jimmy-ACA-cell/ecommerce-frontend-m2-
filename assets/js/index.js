...
const PRODUCTS = [
  {
    ...
    category: "Máquinas",
    description:
      "Máquina profesional de 2 grupos, ideal para cafeterías con volumen medio-alto.",
  },
  {
    id: "m2",
    ...
    category: "Molinos",
    description:
      "Molino con muelas de 75mm para molienda consistente y duradera.",
  },
  {
    id: "t1",
    title: "Tostadora 5kg",
    ...
    category: "Tostadoras",
    description:
      "Tostadora para pequeños lotes, control de perfil y refrigeración rápida.",
  },
  {
    id: "a1",
    ...
    category: "Accesorios",
    description:
      "Tamper ergonómico con base niveladora y acabado en acero inoxidable.",
  },
  {
    id: "a2",
  ...
  },
  {
    ...
    category: "Café",
    description:
      "Café de especialidad, tueste medio, notas a caramelo y cítricos.",
  },
  {
    id: "c2",
    ...
    category: "Café",
    description:
      " Café verde de especialidad, grano sin tostar, notas a té verde y sutiles toques herbales.",
  },
  {
    id: "c3",
    ...
    category: "Café",
    description:
      "Café de especialidad, tueste oscuro, notas a chocolate amargo y nuez.",
  },
];
      ...
      p.title
        ...
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between mt-3">
            <a href="productos.html?id=${
              p.id
            }" class="btn btn-outline-light">Ver más</a>
            <button class="btn btn-warning add-btn" data-id="${
              p.id
            }">Agregar</button>
          </div>
        </div>
...
function renderProductDetail() {
  ...
  el.innerHTML = `
    <div class="col-md-6">
      <img src="${p.img}" class="img-fluid rounded" alt="${
    p.title
    ...
    <div class="col-md-6">
      ...
      <p>${p.description}</p>
      <div class="mt-4">
        <button class="btn btn-warning btn-lg" id="detail-add" data-id="${
          p.id
...
function showToast(msg) {
  ...
  t.style =
    "position:fixed;right:20px;bottom:20px;background:#111;padding:12px 16px;border-radius:8px;color:white;z-index:9999;opacity:0;transition:opacity .2s";
  t.textContent = msg;
  ...
  if (ids.length === 0) {
    ...
    ids.forEach((id) => {
      ...
      row.innerHTML = `
        <img src="${
          product.img
        }" style="width:84px;height:64px;object-fit:cover;border-radius:8px;margin-right:12px">
        <div class="flex-grow-1">
          <div class="d-flex justify-content-between align-items-start">
            ...
            <div class="text-end">
              ...
              <small class="text-muted">Unit ${formatPrice(
                product.price
              )}</small>
            </div>
          </div>
